...
reading `.claude/skills/onboarding/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/onboarding/SKILL.md` for the workflow details.
