...
reading `.claude/skills/emissary/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/emissary/SKILL.md` for the workflow details.
