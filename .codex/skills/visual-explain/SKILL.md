...
# Egregore visual-explain Adapter
...
reading `.claude/skills/visual-explain/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/visual-explain/SKILL.md` for the workflow details.
