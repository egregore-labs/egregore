---
name: quest-suggest
description: 'Fallback Codex adapter for the Egregore quest-suggest workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore quest-suggest Adapter
...
1. Read `.claude/skills/quest-suggest/SKILL.md` for the workflow details.
