---
name: infra
description: 'Fallback Codex adapter for the Egregore infra workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore infra Adapter
...
reading `.claude/skills/infra/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/infra/SKILL.md` for the workflow details.
