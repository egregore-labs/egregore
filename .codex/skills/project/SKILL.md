---
name: project
description: 'Fallback Codex adapter for the Egregore project workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore project Adapter
...
reading `.claude/skills/project/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/project/SKILL.md` for the workflow details.
