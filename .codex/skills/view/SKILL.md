---
name: view
description: 'Fallback Codex adapter for the Egregore view workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore view Adapter
...
reading `.claude/skills/view/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/view/SKILL.md` for the workflow details.
