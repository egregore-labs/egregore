...
reading `.claude/skills/tutorial/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/tutorial/SKILL.md` for the workflow details.
