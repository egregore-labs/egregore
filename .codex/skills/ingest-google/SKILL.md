---
name: ingest-google
description: 'Fallback Codex adapter for the Egregore ingest-google workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore ingest-google Adapter
...
1. Read `.claude/skills/ingest-google/SKILL.md` for the workflow details.
