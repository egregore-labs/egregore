---
name: todo
description: 'Fallback Codex adapter for the Egregore todo workflow.'
---

<!-- generated-by: bin/codex-sync-skills.sh -->

# Egregore todo Adapter
...
reading `.claude/skills/todo/SKILL.md`, reproduce the same visible UX in Codex:
...
1. Read `.claude/skills/todo/SKILL.md` for the workflow details.
